...
restful_api.add_resource(LibvirtDestroy, '/libvirt/<string:driver>/nodes/<string:uuid_or_name>/destroy')
...
restful_api.add_resource(LibvirtResizeMemory, '/libvirt/<string:driver>/nodes/<string:uuid_or_name>/memory/resize')
restful_api.add_resource(LibvirtResizeVcpu, '/libvirt/<string:driver>/nodes/<string:uuid_or_name>/vcpu/resize')
